...
public class TileType {
    ...
    public static final TileType presurepad = new TileType(2).name("pressure pad").enter().seeThru().ch('o').icon(2).color(Color.BROWN);
    ...
    public static final TileType pit = new TileType(9).name("pit").enter().seeThru().ch('X').icon(9).color(Color.BROWN);
    public static final TileType wall = new TileType(10).name("wall").ch('#').icon(10).color(Color.GRAY);
    public static final TileType uplever = new TileType(11).name("up lever").ch('\\').icon(11).color(Color.GRAY);
    public static final TileType downlever = new TileType(12).name("down lever").ch('/').icon(12).color(Color.GRAY);
    public static final TileType message = new TileType(13).name("message").ch('m').icon(13).color(Color.GRAY);
    ...
    public static final TileType button = new TileType(16).name("button").ch('B').icon(16).color(Color.GRAY);
    public static final TileType door = new TileType(17).name("door").ch('[').icon(17).color(Color.BROWN);
    public static final TileType lockeddoor = new TileType(18).name("locked door").ch(']').icon(18).color(Color.BROWN);
    public static final TileType opendoor = new TileType(19).name("open door").ch('_').enter().seeThru().icon(19).color(Color.BROWN);
    public static final TileType gate = new TileType(20).name("gate").ch('G').seeThru().icon(20).color(Color.GRAY);
    ...
    public static final TileType stairs = new TileType(24).name("stairs").ch('%').seeThru().enter().icon(24).color(Color.GRAY);
    public static final TileType window = new TileType(25).name("window").ch('+').seeThru().icon(25).color(Color.GRAY);
    ...
    public static final TileType openlockeddoor = new TileType(45).name("opened locked door").ch('<').seeThru().enter().icon(45).color(Color.BROWN);
    public static final TileType openlockedgate = new TileType(46).name("opened locked gate").ch('>').seeThru().enter().icon(46).color(Color.BROWN);
